  ...
  return (
    <section className="bg-brand-light">
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div className="p-36 flex flex-col justify-center">
          <svg
            width="122"
            height="20"
            viewBox="0 0 122 20"
          ...
          <h2 className="text-4xl font-bold text-black">Conferences</h2>
          <p className="text-black mt-6 text-balance">
            Energy-boosting openers or closers that bring your audience together
            with rhythm and joy.
          </p>
        </div>
